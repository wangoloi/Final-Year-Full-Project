      ...
      <div className="relative flex w-full max-w-[520px] flex-col items-stretch">
        ...
        <div className="relative w-full rounded-[20px] bg-white p-10 shadow-[0_25px_50px_rgba(0,0,0,0.15)] max-sm:p-7">
          ...
          <ul className="m-0 mb-6 list-none p-0 text-left">
            <li className="flex items-start gap-3 border-b border-slate-200 py-3 text-[0.9375rem] text-slate-700 first:pt-0 last:border-b-0">
            ...
            <li className="flex items-start gap-3 border-b border-slate-200 py-3 text-[0.9375rem] text-slate-700 last:border-b-0">
            ...
            <li className="flex items-start gap-3 py-3 text-[0.9375rem] text-slate-700 last:border-b-0">
