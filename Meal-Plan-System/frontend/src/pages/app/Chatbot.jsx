        ...
        <div className="chat-main">
          ...
          <div className="chat-messages min-h-0 min-w-0 flex-1 overflow-y-auto p-4">
            {messages.length === 0 && !loading && (
              <div className="chat-empty-hint text-center p-5">
                <p className="mb-2 text-base text-slate-700">
                  Start here — ask what the assistant can do, or jump into a food question.
                </p>
                <p className="text-muted mb-0 text-sm leading-relaxed">
                  Try &quot;What do you offer?&quot; or &quot;Is matooke good for diabetes?&quot;
                </p>
              </div>
            )}
            {messages.map((m, i) => (
              ...
              >
                <div
                  className={`chat-content ${m.role === 'user' ? 'chat-content--user' : 'chat-content--assistant'}`}
                >
                  <ChatMessageContent
                    content={m.content}
