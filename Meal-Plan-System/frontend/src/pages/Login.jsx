      ...
      <div className="relative flex w-full max-w-[520px] flex-col items-stretch">
        ...
        <div className="relative w-full rounded-[20px] bg-white p-10 shadow-[0_25px_50px_rgba(0,0,0,0.15)] max-sm:p-7">
          <div className="mb-8 text-center">
            ...
            <p className="m-0 text-base text-slate-500">Sign in to your account</p>
          </div>
          {error && <div className="alert alert-error mb-5 rounded-[10px]">{error}</div>}
          <form onSubmit={handleSubmit}>
            <div className="mb-5">
              <label className="mb-2 block text-[0.9375rem] font-medium text-slate-700">Username or Email</label>
              <input
                type="text"
                className="w-full rounded-[10px] border border-slate-200 px-4 py-3.5 text-base transition-all focus:border-blue-600 focus:shadow-[0_0_0_3px_rgba(37,99,235,0.1)] focus:outline-none"
                value={username}
            ...
            <div className="mb-5">
              <label className="mb-2 block text-[0.9375rem] font-medium text-slate-700">Password</label>
              <input
                type="password"
                className="w-full rounded-[10px] border border-slate-200 px-4 py-3.5 text-base transition-all focus:border-blue-600 focus:shadow-[0_0_0_3px_rgba(37,99,235,0.1)] focus:outline-none"
                value={password}
