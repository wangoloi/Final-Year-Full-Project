...
export default function Register() {
  ...
  const inputClass =
    'w-full rounded-[10px] border border-slate-300 bg-white px-4 py-3.5 text-base text-slate-900 placeholder:text-slate-500 transition-all focus:border-blue-600 focus:shadow-[0_0_0_3px_rgba(37,99,235,0.1)] focus:outline-none';
      ...
      <div className="relative flex w-full max-w-[520px] flex-col items-stretch">
        ...
        <div className="relative w-full rounded-[20px] bg-white p-10 shadow-[0_25px_50px_rgba(0,0,0,0.15)] max-sm:p-7">
          <div className="mb-8 text-center">
            ...
            <Heading level={1} className="mb-1">Create Account</Heading>
            <Text tone="muted">Join Glocusense today</Text>
          </div>
