        ...
        <div className="mx-auto flex w-full max-w-[1200px] items-center justify-between px-4 lg:px-8">
          ...
          <div className="flex flex-wrap items-center gap-1">
            <NavLink
              to="/app"
              className={({ isActive }) =>
                `flex items-center gap-2 rounded px-3.5 py-2 text-sm font-medium text-white/90 no-underline transition-colors hover:bg-white/20 hover:text-white ${isActive ? 'bg-white/20 text-white' : ''}`
              }
              end
            >
            ...
            >
              ...
              <span className="max-md:hidden">Meal plan</span>
            </NavLink>
            <NavLink
              to="/app/chatbot"
              className={({ isActive }) =>
            ...
            >
              ...
              <span className="max-md:hidden">Recommendations</span>
            </NavLink>
            <NavLink
              to="/app/glucose"
              className={({ isActive }) =>
            ...
            >
              ...
              <span className="max-md:hidden">Sensor</span>
            </NavLink>
            <button
              type="button"
              className="ml-3 flex cursor-pointer items-center gap-2 rounded border-none bg-transparent px-3.5 py-2 text-sm font-medium text-white/90 transition-colors hover:bg-white/20 hover:text-white"
              onClick={logout}
            >
